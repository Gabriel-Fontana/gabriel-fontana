...
I am currently focused on **Cloud Computing and DevOps**, specializing in the **architecture and implementation of scalable and resilient systems**.  
I have hands-on experience with **Linux, Kubernetes, and Infrastructure as Code**, applying best practices for **automation and IT environment optimization**.  

I am deepening my knowledge in **AWS and Azure**, developing practical projects that combine theory with real-world application, always aiming to deliver **robust and innovative solutions**.
